...
public class LifeBoard {
    ...
    public boolean getCell(int row, int col) //check that we're in the array
    {
    ...
    public void randomise()
    {
        for(int row = 0; row < size; row++)
        {
            for(int col = 0; col < size; col++)
            {
                float dice = p.random(0, 1); //java way to get random numbers -> method on the PApplet class
